...
@section('content')
    <div class="row">
        <div class="page-head">
            <h2 class="page-head-title">Quản lý khách hàng tư vấn</h2>
            ...
            <ol class="breadcrumb page-head-nav">
                ...
                <li class="active">Quản lý khách hàng tư vấn</li>
            </ol>
        </div>
    </div>
    <div class="col-sm-12">
                    ...
                    @else
                        @foreach($news as $new)
                            <tr>
                                ...
                                <td><a title="Sửa trạng thái" style="margin-left: 10px;" href="/admin/custormer/form/{{ $new->id }}" class="icon"><i class="mdi mdi-wrench"></i></a></td>
                            </tr>
                        @endforeach
                    @endif
                    </tbody>
